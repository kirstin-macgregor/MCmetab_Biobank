...
write.csv(mod_out_simple,
          'P:/C3_Integrative_Physiology_Group/PeoplesData/Kirstin/Projects/UoS/MC and metabolites_BioBank/Analysis/data/out/Rhythmicity analysis/MC~metab_simple.csv')
```
...
write.csv(mod_out_fastingDur, 'P:/C3_Integrative_Physiology_Group/PeoplesData/Kirstin/Projects/UoS/MC and metabolites_BioBank/Analysis/data/out/Rhythmicity analysis/MC~metab_fastingDur.csv')
```
...
write.csv(mod_out_fastingDur,
          'P:/C3_Integrative_Physiology_Group/PeoplesData/Kirstin/Projects/UoS/MC and metabolites_BioBank/Analysis/data/out/Rhythmicity analysis/MC~metab_MCexcluded.csv')
```
