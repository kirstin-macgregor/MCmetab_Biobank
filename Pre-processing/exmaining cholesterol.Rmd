...
med_perc_plot <- ggplot2::ggplot(
  ...
  ggplot2::ylab("count (%)") +
  ggplot2::theme_bw() +
  ggplot2::geom_text(ggplot2::aes(label = paste(perc, " %")), vjust = 0)

med_plots <- ggpubr::ggarrange(med_count_plot, med_perc_plot)
...
statin_perc_plot <-
  ...
  ggplot2::ylab("count (%)") +
  ggplot2::theme_bw() +
  ggplot2::geom_text(ggplot2::aes(label = paste(round(perc, 1), " %")), vjust = 0)

statin_plots <- ggpubr::ggarrange(statin_count_plot, statin_perc_plot)

CVmeds_count_plot <- ggplot2::ggplot(data = data, ggplot2::aes(CVmeds)) +
  ggplot2::geom_bar() +
  ggplot2:::ggtitle("CV medication") +
  ggplot2::ylab("count (%)") +
  ggplot2::theme_bw() +
  ggplot2::geom_text(stat = "count", ggplot2::aes(label = ggplot2::after_stat(count)), vjust = 0)
...
CVmeds_plots <- ggpubr::ggarrange(CVmeds_count_plot, CVmeds_perc_plot)
```
